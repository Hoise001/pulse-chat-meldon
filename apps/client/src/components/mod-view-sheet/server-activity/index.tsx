    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          {t('modView.serverActivity.title')}
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-2">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm">{t('modView.serverActivity.messages')}</span>
          </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm">{t('modView.serverActivity.links')}</span>
          </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm">{t('modView.serverActivity.files')}</span>
          </div>
